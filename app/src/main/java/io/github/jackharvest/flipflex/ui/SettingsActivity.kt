...
import io.github.jackharvest.flipflex.plex.PlexProfiles
        ...
        list.submit(
            listOf(
                RowList.Row(
                    ...
                    payload = Entry { startActivity(intent(this, MODE_PROFILE)) },
                ),
                RowList.Row(
                    title = "Server",
                    subtitle = store.serverName ?: "None",
                    payload = Entry { startActivity(intent(this, MODE_SERVER)) },
                ),
                RowList.Row(
                    title = "Libraries",
                    subtitle = hiddenSummary(),
                    payload = Entry { startActivity(intent(this, MODE_LIBRARIES)) },
                ),
                RowList.Row(
                    title = "Sign out",
